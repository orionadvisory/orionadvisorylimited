...
export function QuestionCard({
  ...
  // Always show a supplement textbox and a file upload on every question,
  // except when the primary input IS the file upload itself.
  const showAttachment = question.inputType !== "file_upload";
  const showSupplement = true;
  const supplementValue = answers[`${question.questionKey}__followup`];
        ...
        {showSupplement && (
          <div className="mt-2">
            ...
            <textarea
              ...
              placeholder="Add anything else the legal team should know about this answer..."
              rows={3}
              className={inputClass}
            />
          </div>
